<script lang="ts">
	...
	const navItems: { id: View; label: string; icon: string }[] = [
		...
		{ id: 'disk-pulse', label: 'Disk Pulse', icon: 'pulse' },
		{ id: 'storage-recovery', label: 'Storage Recovery', icon: 'storage' },
		...
		const icons: Record<string, string> = {
			...
			pulse: 'M13 10V3L4 14v7l9-4v-7zM3 10l10-4v8l-10 4v-8z',
			storage: 'M4 4h16v16H4V4zm2 2v12h12V6H6zm2 2h8v2H8V8zm0 4h8v2H8v-2zm0 4h5v2H8v-2z',
