		...
		<nav class="container mx-auto px-4 py-4 max-w-7xl">
			<div class="flex items-center justify-between">
				...
				<div class="flex items-center gap-4">
					...
					<a href="{base}/features" class="text-sm font-medium text-[var(--color-text-secondary)] hover:text-[var(--color-text)]">Features</a>
		...
		<div class="space-y-4 mb-12">
			...
			<div class="card overflow-hidden">
				...
				>
					...
					<p class="mt-3">
						Visit our <a href="{base}/download" class="text-primary-600 hover:underline">Download page</a> for detailed instructions.
					</p>
				</div>
			</div>
